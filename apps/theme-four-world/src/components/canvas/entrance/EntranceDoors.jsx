...
const EntranceDoors = ({
    ...
    const frameTexture = useTexture('/theme-four-experience/textures/doors/frame_sketch.webp');
    const doorLeftTexture = useTexture('/theme-four-experience/textures/doors/door_left_sketch.webp');
    const doorRightTexture = useTexture('/theme-four-experience/textures/doors/door_right_sketch.webp');

    // Mobile optimization: Don't load painted textures or handles on phones
    const doorRightPaintedTexture = useTexture(isMobileDevice ? dummyTex : '/theme-four-experience/textures/doors/door_right_painted.webp');
    const doorLeftPaintedTexture = useTexture(isMobileDevice ? dummyTex : '/theme-four-experience/textures/doors/door_left_painted.webp');
    const handleLeftTexture = useTexture('/theme-four-experience/textures/doors/handle_left_sketch.webp');
    const handleLeftPaintedTexture = useTexture(isMobileDevice ? dummyTex : '/theme-four-experience/textures/doors/handle_left_painted.webp');
    const handleRightTexture = useTexture('/theme-four-experience/textures/doors/handle_right_sketch.webp');
    const handleRightPaintedTexture = useTexture(isMobileDevice ? dummyTex : '/theme-four-experience/textures/doors/handle_right_painted.webp');

    // Dynamic textures for mobile
    const doorBackTexture = useTexture(isMobileDevice ? '/theme-four-experience/textures/doors/door_back.webp' : '/theme-four-experience/textures/doors/door_back_left_sketch.webp');
    const edgeTexture = useTexture(isMobileDevice ? '/theme-four-experience/textures/doors/pien_sketch.webp' : '/theme-four-experience/textures/doors/pien.webp');

    const bricksTexture = useTexture('/theme-four-experience/textures/entrance/wall_bricks_2.webp');
    const stonePathTexture = useTexture('/theme-four-experience/textures/entrance/stone-path.webp');
    // const catTexture = useTexture('/theme-four-experience/textures/entrance/cat_sketch.webp'); // Old side cat
    const catFrontBodyTexture = useTexture('/theme-four-experience/textures/entrance/cat_front_body.webp');
    const windowSketchTexture = useTexture('/theme-four-experience/textures/entrance/window_sketch.webp');
    const treeTexture = useTexture('/theme-four-experience/textures/entrance/tree_sketch.webp');
    const mouseTexture = useTexture('/theme-four-experience/textures/entrance/mouse_hanging.webp');
    const potTexture = useTexture('/theme-four-experience/textures/entrance/pot_with_duck.webp');
    const bugTexture = useTexture('/theme-four-experience/textures/entrance/bug_sketch.webp');
    const inkSplashTexture = useTexture('/theme-four-experience/images/ink-splash.webp');
    const speechBubbleTexture = useTexture('/theme-four-experience/textures/entrance/speech_bubble.webp');
