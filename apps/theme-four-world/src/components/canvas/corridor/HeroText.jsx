...
const RUBIK_SCRIBBLE_URL = '/theme-four-experience/fonts/RubikScribble-Regular.ttf';
 ...
 * - XM-GAMES in Rubik Scribble font (splits into letters during scroll)
 * - Play-anywhere tagline in Cabin Sketch font (also splits)
...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for XM-GAMES split effect
    const letters = useMemo(() => [
        { char: 'X', baseX: -1.42, splitDir: -1.8 },
        { char: 'M', baseX: -1.01, splitDir: -1.25 },
        { char: '-', baseX: -0.62, splitDir: -0.75 },
        { char: 'G', baseX: -0.25, splitDir: -0.3 },
        { char: 'A', baseX: 0.18, splitDir: 0.3 },
        { char: 'M', baseX: 0.61, splitDir: 0.8 },
        { char: 'E', baseX: 1.04, splitDir: 1.3 },
        { char: 'S', baseX: 1.43, splitDir: 1.85 },
    ], []);

    // Tagline words for split effect
    const taglineWords = useMemo(() => [
        { text: '<', baseX: -0.85, splitDir: -1.5, delay: 0 },
        { text: 'play', baseX: -0.4, splitDir: -0.8, delay: 0 },
        { text: 'anywhere', baseX: 0.4, splitDir: 0.8, delay: 0 },
        { text: '/>', baseX: 0.85, splitDir: 1.5, delay: 0 },
    ], []);
    ...
    useFrame((state, delta) => {
        ...
        // Apply split to each letter of XM-GAMES
