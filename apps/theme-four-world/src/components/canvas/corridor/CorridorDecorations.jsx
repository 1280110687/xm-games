...
const CABIN_SKETCH_URL = '/theme-four-experience/fonts/CabinSketch-Regular.ttf';
...
const CorridorDecorations = ({ segmentLength, zOffset, corridorWidth = 4, corridorHeight = 3.5, zClip = 100000, setCameraOverride }) => {
    ...
    // TEKSTURY DEKORACJI
    // =============================================
    const frameTexture = useTexture('/theme-four-experience/textures/corridor/ramkanazdjecieduza.webp');
    const framePaintedTexture = useTexture('/theme-four-experience/textures/corridor/ramkanazdjecieduza_painted.webp');
    const standingFrameTexture = useTexture('/theme-four-experience/textures/corridor/ramkanazdjeciemala.webp');
    const treeTexture = useTexture('/theme-four-experience/textures/corridor/drzewkowdoniczce.webp');
    const grateTexture = useTexture('/theme-four-experience/textures/corridor/kratkawentylacyjna.webp');
    const flowerTexture = useTexture('/theme-four-experience/textures/corridor/kwiatekwdoniczce.webp');

    // --- Ceiling Lights (punkty światła) ---
    // Tekstury lamp
    const lampGrilleTexture = useTexture('/theme-four-experience/textures/corridor/kratanalampy.webp');
    // lampGrilleTexture.wrapS = lampGrilleTexture.wrapT = THREE.RepeatWrapping; 
    // lampGrilleTexture.repeat.set(1, 1);

    const lampSideTexture = useTexture('/theme-four-experience/textures/corridor/bokilampy.webp');
    ...
    const frames = useMemo(() => [
        {
            ...
            image: '/theme-four-experience/textures/corridor/rysuneknaobraz1.webp',
            imageWidth: 1.1,
            imageHeight: 1.1,
        ...
        },
        {
            ...
            y: 0.2,
            id: 'frame-2',
            image: '/theme-four-experience/textures/corridor/rysuneknaobrazek3.webp',
            imageWidth: 1.7,
            imageHeight: 1,
            offsetFromWall: 0.1
        },
    ...
    // STOLIK (TABLE)
    // =============================================
    const woodTexture = useTexture('/theme-four-experience/textures/corridor/texturadrewnadonozekbiurka.webp');
    const tableTopTexture = useTexture('/theme-four-experience/textures/corridor/gorastolika.webp');

    // Tekstury szafki
    const cabinetFrontTexture = useTexture('/theme-four-experience/textures/corridor/szafkaprzod.webp');
    const cabinetRestTexture = useTexture('/theme-four-experience/textures/corridor/szafkaprzodgora.webp');
