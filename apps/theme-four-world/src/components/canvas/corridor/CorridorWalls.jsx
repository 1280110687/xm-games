...
const CorridorWalls = ({ zStart = 10, length = 80, doorPositions = [], zClip = 100000 }) => {
    ...
    const floorTexture = useTexture('/theme-four-experience/textures/corridor/kawalekpodlogi.webp');
    ...
    const ceilingTexture = useTexture('/theme-four-experience/textures/corridor/ceiling_texture.webp');
