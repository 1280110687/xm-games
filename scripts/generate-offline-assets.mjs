...
const offlineDirectories = ["theme-four", "theme-four-experience", "images/theme-arcade", "images/theme-pocket", "images/theme-three", "images/theme-retro", "fonts/silkscreen"]
