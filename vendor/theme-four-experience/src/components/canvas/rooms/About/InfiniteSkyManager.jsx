...
const IntroMilestone = ({ z, scrollProgressRef }) => {
    // Load avatar texture
    const avatarTexture = useLoader(THREE.TextureLoader, '/theme-four-experience/textures/about/awatarnachmurce.webp');
...
const AWARDS_DATA = {
    featured: {
        ...
        items: [
            { label: 'Featured - Awwwards', date: 'May 2025', image: '/theme-four-experience/textures/about/SOTY.webp', url: 'https://awwwards.com' },
            { label: 'Featured - CSS Design Awards', date: 'June 2025', image: '/theme-four-experience/textures/about/SOTY.webp', url: 'https://cssdesignawards.com' },
            { label: 'Featured - The FWA', date: 'July 2025', image: '/theme-four-experience/textures/about/SOTY.webp', url: 'https://thefwa.com' },
            { label: 'Featured - Behance', date: 'August 2025', image: '/theme-four-experience/textures/about/SOTY.webp', url: 'https://behance.net' },
        ],
        platformConfig: {
            label: 'HONOR',
            color: '#1a1a1a',
    ...
    sotd: {
        ...
        items: [
            { label: 'SOTD - GSAP', date: 'February 13, 2026', image: '/theme-four-experience/textures/about/SOTDAYYOUNGMULTIGSAP.webp', url: 'https://www.linkedin.com/posts/greensock_site-of-the-day-young-multi-this-immersive-activity-7427567524940017664-zU2n?utm_source=share&utm_medium=member_desktop&rcm=ACoAAE3TV6UBqXoaJXUN5-1s3ij6SQJwTRAcbCM' },
            { label: 'SOTD - CSS Winner', date: 'January 24, 2026', image: '/theme-four-experience/textures/about/SOTDAYYOUNGMULTICSSWINNER.webp', url: 'https://www.csswinner.com/details/young-multi-official-experience/19045' },
            { label: 'SOTD - Orpetron', date: 'January 29, 2026', image: '/theme-four-experience/textures/about/SOTDAYYOUNGMULTIORPETRON.webp', url: 'https://orpetron.com/sites/young-multi/' },
            { label: 'SOTD - Design Nominess', date: 'February 17, 2026', image: '/theme-four-experience/textures/about/SOTDAYYOUNGMULTIDESIGNNOMINESS.webp', url: 'https://www.designnominees.com/sites/young-multi' }
        ],
        platformConfig: {
            label: 'AWARD',
            color: '#1a1a1a',
...
const AwardsMilestone = ({ z, scrollProgressRef }) => {
    ...
    // Load textures
    const sotyTexture = useLoader(THREE.TextureLoader, '/theme-four-experience/textures/about/SOTY.webp');
    const sotdTexture = useLoader(THREE.TextureLoader, '/theme-four-experience/textures/about/SOTD.webp');
    const sotmTexture = useLoader(THREE.TextureLoader, '/theme-four-experience/textures/about/SOTM.webp');
    const sotyPaintedTexture = useLoader(THREE.TextureLoader, isTouch ? '/theme-four-experience/textures/about/SOTY.webp' : '/theme-four-experience/textures/about/SOTY_painted.webp');
    const sotdPaintedTexture = useLoader(THREE.TextureLoader, isTouch ? '/theme-four-experience/textures/about/SOTD.webp' : '/theme-four-experience/textures/about/SOTD_painted.webp');
    const sotmPaintedTexture = useLoader(THREE.TextureLoader, isTouch ? '/theme-four-experience/textures/about/SOTM.webp' : '/theme-four-experience/textures/about/SOTM_painted.webp');
    const buttonTexture = useLoader(THREE.TextureLoader, '/theme-four-experience/textures/about/button.webp');
    const buttonPaintedTexture = useLoader(THREE.TextureLoader, isTouch ? '/theme-four-experience/textures/about/button.webp' : '/theme-four-experience/textures/about/button_painted.webp');
...
const JourneyMilestone = ({ z, scrollProgressRef }) => {
    ...
    // Load textures
    const uoTexture = useLoader(THREE.TextureLoader, '/theme-four-experience/textures/about/uowyspa.webp');
    const freelanceTexture = useLoader(THREE.TextureLoader, '/theme-four-experience/textures/about/freelancewyspa.webp');
...
const BALLOON_CONFIG = [
    ...
    { texture: '/theme-four-experience/textures/about/reactduzybalon.webp', paintedTexture: '/theme-four-experience/textures/about/reactduzybalon_painted.webp', label: 'React', size: 'large', x: -2.5, y: 2, z: 0.3, phase: 0 },
    { texture: '/theme-four-experience/textures/about/threejsduzybalon.webp', paintedTexture: '/theme-four-experience/textures/about/threejsduzybalon_painted.webp', label: 'Three.js', size: 'large', x: 2.5, y: 2.5, z: 0.2, phase: 1.5 },
    { texture: '/theme-four-experience/textures/about/GSAPduzybalon.webp', paintedTexture: '/theme-four-experience/textures/about/GSAPduzybalon_painted.webp', label: 'GSAP', size: 'large', x: 0, y: 3, z: 0.5, phase: 3 },

    // Medium balloons - scattered around
    { texture: '/theme-four-experience/textures/about/JSSREDNIBALON.webp', paintedTexture: '/theme-four-experience/textures/about/JSSREDNIBALON_painted.webp', label: 'JavaScript', size: 'medium', x: -4, y: 1, z: -0.3, phase: 0.8 },
    { texture: '/theme-four-experience/textures/about/csssrednibalon.webp', paintedTexture: '/theme-four-experience/textures/about/csssrednibalon_painted.webp', label: 'CSS', size: 'medium', x: 4, y: 1.5, z: -0.2, phase: 2.2 },
    { texture: '/theme-four-experience/textures/about/nextjssrednibalon.webp', paintedTexture: '/theme-four-experience/textures/about/nextjssrednibalon_painted.webp', label: 'Next.js', size: 'medium', x: 0, y: 0.5, z: -0.4, phase: 4 },

    // Small balloons - background accents
    { texture: '/theme-four-experience/textures/about/htmlmalybalon.webp', paintedTexture: '/theme-four-experience/textures/about/htmlmalybalon_painted.webp', label: 'HTML', size: 'small', x: -5.5, y: 2.5, z: -0.8, phase: 1.2 },
    { texture: '/theme-four-experience/textures/about/gitmalybalon.webp', paintedTexture: '/theme-four-experience/textures/about/gitmalybalon_painted.webp', label: 'Git', size: 'small', x: 5.5, y: 3, z: -0.7, phase: 2.8 },
    { texture: '/theme-four-experience/textures/about/figmamalybalon.webp', paintedTexture: '/theme-four-experience/textures/about/figmamalybalon_painted.webp', label: 'Figma', size: 'small', x: -3, y: 4.5, z: -0.5, phase: 3.5 },
    { texture: '/theme-four-experience/textures/about/firebasemalybalon.webp', paintedTexture: '/theme-four-experience/textures/about/firebasemalybalon_painted.webp', label: 'Firebase', size: 'small', x: 3.5, y: 4, z: -0.6, phase: 4.5 },
];
    ...
    return (
        ...
        >
            <group ref={innerGroupRef}>
                ...
                <PositionalAudio
                    ref={balloonAudioRef}
                    url="/theme-four-experience/sounds/baloonpoop.mp3"
