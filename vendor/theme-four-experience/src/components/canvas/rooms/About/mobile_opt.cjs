...
content = content.replace(
    ...
    `const sotyPaintedTexture = useLoader(THREE.TextureLoader, isMobile ? '/theme-four-experience/textures/about/SOTY.webp' : '/theme-four-experience/textures/about/SOTY_painted.webp');
    const sotdPaintedTexture = useLoader(THREE.TextureLoader, isMobile ? '/theme-four-experience/textures/about/SOTD.webp' : '/theme-four-experience/textures/about/SOTD_painted.webp');
    const sotmPaintedTexture = useLoader(THREE.TextureLoader, isMobile ? '/theme-four-experience/textures/about/SOTM.webp' : '/theme-four-experience/textures/about/SOTM_painted.webp');
    const buttonTexture = useLoader(THREE.TextureLoader, '/theme-four-experience/textures/about/PRZYCISKSOTD.webp');
    const buttonPaintedTexture = useLoader(THREE.TextureLoader, isMobile ? '/theme-four-experience/textures/about/PRZYCISKSOTD.webp' : '/theme-four-experience/textures/about/PRZYCISKSOTD_painted.webp');`
);
