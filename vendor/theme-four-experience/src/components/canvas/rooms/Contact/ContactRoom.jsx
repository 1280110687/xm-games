...
const ContactRoom = ({ showRoom, onReady, isExiting, isWarmup }) => {
    ...
    const latarniaTexture = useTexture("/theme-four-experience/textures/contact/latarnia.webp");
    // Load Statek Texture
    const statekTexture = useTexture("/theme-four-experience/textures/contact/statek.webp");
