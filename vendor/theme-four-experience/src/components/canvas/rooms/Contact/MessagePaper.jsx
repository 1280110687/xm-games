...
const FONT_PATH = '/theme-four-experience/fonts/CabinSketch-Regular.ttf';
...
const MessagePaper = ({ position = [0, 0.05, 2], onSend }) => {
    ...
    // Load textures
    const paperTexture = useTexture('/theme-four-experience/textures/contact/paper_form.webp');
    const buttonTexture = useTexture('/theme-four-experience/textures/contact/send_button.webp');
