...
const SegmentDoors = ({
    ...
    const frameTexture = useTexture('/theme-four-experience/textures/corridor/doors/frame_sketch.webp');
    const doorLeftTexture = useTexture('/theme-four-experience/textures/corridor/doors/doorrleft.webp');
    const doorRightTexture = useTexture('/theme-four-experience/textures/corridor/doors/dorright.webp');
    const handleLeftTexture = useTexture('/theme-four-experience/textures/corridor/doors/handle_left_sketch.webp');
    const handleRightTexture = useTexture('/theme-four-experience/textures/corridor/doors/handle_right_sketch.webp');
    const doorBackTexture = useTexture('/theme-four-experience/textures/corridor/doors/door_back.webp');
    const edgeTexture = useTexture('/theme-four-experience/textures/corridor/doors/pien.webp');
    const wallTexture = useTexture('/theme-four-experience/textures/corridor/wall_texture.webp');

    wallTexture.wrapS = wallTexture.wrapT = THREE.RepeatWrapping;

    // Baseboard texture (1582x94 px)
    const baseboardTexSrc = useTexture('/theme-four-experience/textures/corridor/texturadoprogow.webp');
    ...
    // Wall Decorations
    const whileTrueTexture = useTexture('/theme-four-experience/textures/corridor/decorations/while_true_loop.webp');
    const coffeeTexture = useTexture('/theme-four-experience/textures/corridor/decorations/coffee_debug.webp');
    const ideaTexture = useTexture('/theme-four-experience/textures/corridor/decorations/idea_process.webp');
    ...
    return (
        <group position={[position[0], 0, position[2]]}>
            ...
            */}
            ...
            <PositionalAudio
                ref={openAudioRef}
                url="/theme-four-experience/sounds/otwarciedrzwi.mp3"
            ...
            <PositionalAudio
                ref={closeAudioRef}
                url="/theme-four-experience/sounds/zamknieciedrzwi.mp3"
                distanceModel="exponential"
                rolloffFactor={SEGMENT_DOOR_AUDIO_SETTINGS.rolloff}
                refDistance={SEGMENT_DOOR_AUDIO_SETTINGS.distance}
                loop={false}
