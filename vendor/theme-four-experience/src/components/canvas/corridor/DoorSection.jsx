...
const DOOR_TEXTURES = {
    'THE GALLERY': '/theme-four-experience/textures/corridor/doors/drzwiprojekty.webp',
...
const DOOR_PAINTED_TEXTURES = {
    'THE GALLERY': '/theme-four-experience/textures/corridor/doors/drzwiprojekty_painted.webp',
...
const DoorSection = ({
    ...
    // Load wall texture
    const originalWallTexture = useTexture('/theme-four-experience/textures/corridor/wall_texture.webp');
    ...
    const frameTexture = useTexture('/theme-four-experience/textures/corridor/doors/ramkasingledoors.webp');
    const handleTexture = useTexture('/theme-four-experience/textures/corridor/doors/klamkadodrzwi.webp');
    const handlePaintedTexture = useTexture(isTouch ? dummyTex : '/theme-four-experience/textures/corridor/doors/klamkadodrzwi_painted.webp');
    const doorBackTexture = useTexture('/theme-four-experience/textures/corridor/doors/backsingledoors.webp');
    const arrowTexture = useTexture('/theme-four-experience/textures/corridor/strzalka.webp');

    // Baseboard texture for door sections (1582x94 px, aspect 16.83:1)
    const baseboardTexture = useTexture('/theme-four-experience/textures/corridor/texturadoprogow.webp');
    ...
    const signTextureUrl = '/theme-four-experience/textures/corridor/pustatabliczka.webp';
    ...
    return (
        ...
        <group position={[pivotX, position[1], position[2]]}>
            ...
            <group ref={groupRef}>
                ...
                <PositionalAudio
                    ref={hoverAudioRef}
                    url="/theme-four-experience/sounds/uchyleniedrzwi.mp3"
