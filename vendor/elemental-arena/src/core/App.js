...
export class App {
  constructor(canvas) {
    ...
    // The source project is also a VFX authoring tool. In XM-Games this is a
    // playable room first, so keep the editor available behind G without
    // covering a third of the arena on entry.
    this.editor.toggle();
